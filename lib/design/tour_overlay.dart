  ...
  static const steps = <TourStep>[
    TourStep(
      ...
      text: 'Каждый портфель — отдельная история сделок, выплат и планов. '
          'Нажми на портфель, чтобы открыть его.',
      requiresTap: true,
    ),
    TourStep(
      anchor: 'dashboard_hero',
      title: 'Стоимость и прибыль',
      text: 'Сколько сейчас стоят бумаги и сколько ты на них заработал. '
          'График показывает, как менялась стоимость портфеля.',
    ),
    TourStep(
      anchor: 'dashboard_invested',
      title: 'Вложено своих',
      text: 'Только твои деньги, пришедшие извне. Пополнения приложение считает само по сделкам: '
          'продал бумаги и купил новые — вложено не вырастет. Нажми, чтобы открыть счёт.',
    ),
    TourStep(
      anchor: 'dashboard_cash',
      title: 'Свободные деньги',
      text: 'Деньги на счёте, ещё не вложенные в бумаги. Если ты снял их у брокера — '
          'запиши вывод здесь, иначе следующая покупка спишется с них.',
    ),
    TourStep(
      anchor: 'nav_market',
      title: 'Биржа',
      text: 'Все бумаги Мосбиржи с котировками, курсы валют и графики. Загляни туда.',
      requiresTap: true,
    ),
    TourStep(
      anchor: 'market_search',
      title: 'Поиск и фильтры',
      text: 'Найди бумагу по тикеру или названию, отфильтруй по типу. '
          'Тап по строке открывает карточку — купить можно прямо оттуда.',
    ),
    TourStep(
      anchor: 'nav_settings',
      title: 'Настройки',
      text: 'Загрузка с биржи, оформление, резервные копии и это обучение. Открой раздел.',
      requiresTap: true,
    ),
    TourStep(
